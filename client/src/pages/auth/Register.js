...
const Register = () => {
  ...
  return (
    <Layout title="register - Ecommerce Shop">
        ...
        <div className="mb-3">
            <input type="text" value={answer} onChange={(e) => setAnswer(e.target.value)}  className="form-control" id="exampleInputPassword1" placeholder='Which is your Favorite Pet' required />
        </div>
